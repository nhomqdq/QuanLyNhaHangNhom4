				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="Trangchu.php"> </a> <a href="NhanVien.php"> </a> <a href="Thucdon.php"> </a> <span class="lnr lnr-arrow-right"></span>  <a href="NhanVien.php"></a></p>
						</div>	
					</div>
				</div>
