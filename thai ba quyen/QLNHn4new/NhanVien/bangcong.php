	...
	<script>    
        $(document).ready(function(e) {    
            $("#ngay").change(function(){
                ...
                var chuoi="ngay"+ngay;
                //alert(chuoi);
                $.post("../NhanVien/chamcong.php",{ngay:chuoi},function(data){
                    $("#bdcc").html(data);
                });
            });				
        });
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
                          ...
                          <li><a href="#">View Công</a>
										<ul>
											<li><a href="./trangchamcong.php">Chấm Công</a></li>
											<li><a href="#">Xem bảng Công</a></li>
										</ul>
									</li>
				        </ul>
...
<!------------------- body ---------------------->
<div>
<div id="bdbgcong"><h3>Công Tháng</h3><table>
<?php
    include("../connect.php");
    $con=connect();
