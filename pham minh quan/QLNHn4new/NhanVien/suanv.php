...
<html>
  ...
  <!-- Facebook and Twitter integration -->
    ...
    <br />
    <div id="tieude"><h1>SỬA THÔNG TIN</h1></div>
		<br />
<?php
 $id=$_GET["id"];
 include("../Ketnoi.php");
 ...
 if(isset($_POST["btn"])){
     ...
     Chucvu='$chucvu',Maca='$maca',hesoluong=$hsluong,Mabophan='$mabp' WHERE Manhanvien=$id";
		 $con->query($sqlsua);
		 $con->query("update tblcongthang set Tennhanvien='$ten' where Manhanvien=$id");
 }
...
$str='
   ...
   <table>
   <tr>
   <td>TÊN NHÂ VÊN</td><td><input type="text" placeholder="tên nv" name="tennv" value="'.$data["Tennhanvien"].'"></td>
   </tr>
   <tr>
   <td>ĐẠI CHỈ</td><td><input type="text" placeholder="địa chỉ" name="diachi" value="'.$data["Diachi"].'"></td>
   </tr>
   <tr>
   <td>SỐ ĐIỆN THOẠI</td><td><input type="text" placeholder="sđt" name="sdt" value="'.$data["Sodienthoai"].'"></td>
   </tr>
   <tr>
   ...
   <tr>
   <td><input type="submit" name="btn" value="XÁC NHẬN"></td>
   <td><a href="../NhanVien.php">QUAY LẠI</a></td>
   </tr>
   </table>
</form></div>';
echo $str;
