...
<?php
 ...
 if(isset($_POST["btn"])){
    ...
    <table>
          <tr>
									 <td>TÊN NHÂN VIÊN</td>
									 <td><input type="text" placeholder="tên nv" name="tennv" ></td>
         </tr>
   			 <tr>
									<td>NGÀY SINH</td>
									<td><input type="text" placeholder="dd/mm/yyyy" name="ngaysinh" ></td>
          </tr>
         <tr>
									<td>GIỚI TÍNH</td><td id="gt"> 
        ...
        <tr>
         ...
         <tr>
									<td>NGÀY VÀO LÀM</td>
									<td><input type="date" placeholder="dd-mm-yyyy" name="ngaylam" ></td>
         </tr>
         <tr>
									<td>SỐ ĐIỆN THOAI</td>
									<td><input type="text" placeholder="sđt" name="sdt" ></td>
          </tr>
          <tr>
									<td>CHỨC VỤ</td><td>
									<input type="text" placeholder="chức vụ" name="chucvu" ></td>
           </tr>
            <tr>
              ...
              <tr>
									 <td>HỆ SÔ LƯƠNG</td>
									 <td><input type="text" placeholder="hệ số lương" name="hsluong"></td>
               </tr>
              <tr>
                    <td>TÊN BỘ PHẬN</td>
                     <td><select name="mabp" style="margin-left:70px;" class="changesize">';
                      $sql2="select * from tblquanly";
   						...
   						<tr>
   									<td><input type="submit" name="btn" value="THAY ĐỔI"></td>
