<?php
    ...
    if ($addmember)
        echo "BẠN ĐÃ ĐĂNG KÝ TÀI KHOẢN. <a href='http://localhost:8080/phamminhquan/TTCN_HTQLNH/Trangchu.php'>TRANG CHỦ</a>";
    else
        echo "ĐÃ CÓ LỖI TRONG QUÁ TRÌNH ĐĂNG KÝ. <a href='dangky.php'>VUI LÒNG THỬ LẠI</a>";
?>